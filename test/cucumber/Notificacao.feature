...
#    When I add the evaluation "MPA" to the student "Joan", login "jsd" and password "baba"
...
#Controller
  Scenario: Update a report
   ...
   When I add the evaluation "MANA" in the criterion "blah blah" with origin "Mini-Test" and date "26/04/2016" to the student with name "Saulo Henrique Dias" and the login "shd2" and password "lala"
    Then 70% of the student "shd2" evaluations are composed of "MANA"
    And the report "70% of evaluations are MANA" is updated adding the student with login "shd2" and password "lala"
