	...
	<div id="show-student" class="content scaffold-show" role="main">
				...
				<table>
					<thead>
						<tr>
							...
							<g:sortableColumn property="criterion"
								title="${message(code: 'evaluation.criterion.label', default: 'Criterion')}" />

							<g:sortableColumn property="media"
								title="${message(code: 'evaluation.value.label', default: 'Media')}" />

						</tr>
					</thead>
					<tbody>
						<g:each in="${studentInstance?.criteriaAndEvaluations}" status="i"
							var="criteriaAndEvaluations">
							<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
								​
								<td><g:link
										name="${criteriaAndEvaluations.criterion.description}"
										controller="evaluationsByCriterion" action="show"
										id="${criteriaAndEvaluations.id}">
										${fieldValue(bean: criteriaAndEvaluations, field: "criterion.description")}
									</g:link></td> ​
								<td>
									${fieldValue(bean: criteriaAndEvaluations, field: "criterionAverage")}
								</td> ​
							</tr>
						</g:each>
					</tbody>
		...
		<g:form url="[resource:studentInstance, action:'delete']"
			...
			<fieldset class="buttons">
				<g:link class="edit" action="edit" resource="${studentInstance}">
