	...
	<div id="show-student" class="content scaffold-show" role="main">
		...
		<ol class="property-list student">
			...
			<g:if test="${studentInstance?.evaluations}">
				<li class="fieldcontain"><span id="evaluations-label"
					class="property-label"><g:message
							code="student.evaluations.label" default="Evaluations" /></span> <span
					class="property-value" aria-labelledby="evaluations-label"><g:fieldValue
							bean="${studentInstance}" field="evaluations" /></span></li>
			</g:if>
